...
<!--        class="form-group"-->
      <div >
             ...
             <c:forEach items="${list}" var="t" >
                 <p>  <textarea  id="t1" rows="25" style="color: green"   class="form-control"><c:out value="${t.quest}"/></textarea></p>
           ...
           <p><textarea  name="answer1" rows="4"   class="form-control"/><c:out value="${t.answer1}"/></textarea> </p>
              ...
              <p> <input name="${t.id}" type="text"  required="required" class="form-control"/> </p>
      </c:forEach>      
      </div> 
